...
add_sshkey() {
	...
	ip_address
	echo -e "The private key information has been generated. Be sure to copy and save it. It can be saved as${gl_huang}${ipv4_address}_ssh.key${gl_bai} 文件，用于以后的SSH登录"
...
linux_panel() {
	...
	while true; do
	  ...
	  echo -e "${gl_kjlan}------------------------"
	  echo -e "${gl_kjlan}21.  ${gl_bai}VScode网页版                        ${gl_kjlan}22.  ${gl_bai}UptimeKuma monitoring tool"
	  ...
	  echo -e "${gl_kjlan}35.  ${gl_bai}极简朋友圈                          ${gl_kjlan}36.  ${gl_bai}LobeChatAI chat aggregation website"
	  ...
	  echo -e "${gl_kjlan}49.  ${gl_bai}Prometheus (container monitoring)${gl_kjlan}50.  ${gl_bai}补货监控工具"
	  echo -e "${gl_kjlan}------------------------"
	  echo -e "${gl_kjlan}51.  ${gl_bai}PVE open chick panel${gl_kjlan}52.  ${gl_bai}DPanel container management panel"
	  echo -e "${gl_kjlan}53.  ${gl_bai}llama3聊天AI大模型                  ${gl_kjlan}54.  ${gl_bai}AMH host website building management panel"
	  ...
	  echo -e "${gl_kjlan}75.  ${gl_bai}Melody music wizard${gl_kjlan}76.  ${gl_bai}在线DOS老游戏"
	  echo -e "${gl_kjlan}77.  ${gl_bai}迅雷离线下载工具                    ${gl_kjlan}78.  ${gl_bai}PandaWiki intelligent document management system"
